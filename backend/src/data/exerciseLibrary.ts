...
export const EXERCISE_LIBRARY: Exercise[] = [
  ...
  ex("barbell-hip-thrust", "Hip Thrust con Barra", "glutes", "hip_thrust", "compound", "barbell", "intermediate", 9.5, 4, 4, false, "glutes_maximus", ["hamstrings"],
    "https://storage.googleapis.com/lbmethod-assets/exercises/barbell-hip-thrust.gif",
    "https://www.youtube.com/embed/SEdqd1n0cvg"),
  ex("smith-hip-thrust", "Hip Thrust en Máquina Smith", "glutes", "hip_thrust", "compound", "smith", "beginner", 9.2, 4, 3, false, "glutes_maximus", ["hamstrings"],
    "https://storage.googleapis.com/lbmethod-assets/exercises/smith-hip-thrust.gif"),
  ex("machine-glute-bridge", "Máquina de Glúteos (Glute Drive)", "glutes", "hip_thrust", "compound", "machine", "beginner", 9.0, 3, 2, false, "glutes_maximus", ["hamstrings"]),
  ex("db-glute-bridge", "Puente de Glúteos con Mancuerna", "glutes", "hip_thrust", "compound", "dumbbell", "beginner", 8.4, 3, 2, false, "glutes_maximus", ["hamstrings"],
    "https://storage.googleapis.com/lbmethod-assets/exercises/db-glute-bridge.gif"),
  ex("single-leg-hip-thrust", "Hip Thrust en Una Pierna", "glutes", "unilateral", "unilateral", "bodyweight", "intermediate", 8.6, 3, 4, true, "glutes_maximus", ["hamstrings"],
    "https://storage.googleapis.com/lbmethod-assets/exercises/single-leg-hip-thrust.gif"),

  // ---- Glutes: HIP HINGE pattern ------------------------------------------
  ex("romanian-deadlift", "Peso Muerto Rumano con Barra", "glutes", "hip_hinge", "compound", "barbell", "intermediate", 9.0, 4, 4, false, "glutes_maximus", ["hamstrings", "back"],
    "https://storage.googleapis.com/lbmethod-assets/exercises/romanian-deadlift.gif",
    "https://www.youtube.com/embed/JCXUYuzwNrM"),
  ex("db-romanian-deadlift", "Peso Muerto Rumano con Mancuernas", "glutes", "hip_hinge", "compound", "dumbbell", "beginner", 8.6, 4, 3, false, "glutes_maximus", ["hamstrings"],
    "https://storage.googleapis.com/lbmethod-assets/exercises/db-rdl.gif"),
  ex("sumo-deadlift", "Peso Muerto Sumo", "glutes", "hip_hinge", "compound", "barbell", "advanced", 8.8, 5, 4, false, "glutes_maximus", ["hamstrings", "quadriceps"],
    "https://storage.googleapis.com/lbmethod-assets/exercises/sumo-deadlift.gif"),
  ex("cable-pull-through", "Jalón de Cadera en Polea", "glutes", "hip_hinge", "accessory", "cable", "beginner", 8.0, 2, 2, false, "glutes_maximus", ["hamstrings"],
    "https://storage.googleapis.com/lbmethod-assets/exercises/cable-pull-through.gif"),
  ex("kettlebell-swing", "Swing con Pesa Rusa", "glutes", "hip_hinge", "accessory", "kettlebell", "intermediate", 7.5, 3, 3, false, "glutes_maximus", ["hamstrings"]),
  ex("good-morning", "Buenos Días con Barra", "glutes", "hip_hinge", "compound", "barbell", "advanced", 8.2, 4, 4, false, "glutes_maximus", ["hamstrings"]),
  ...
  ex("glute-focus-leg-press", "Prensa con Pie Alto (enfoque glúteo)", "glutes", "knee_dominant", "compound", "machine", "beginner", 8.4, 4, 2, false, "glutes_maximus", ["hamstrings"],
  ...
  ex("bulgarian-split-squat", "Sentadilla Búlgara", "glutes", "unilateral", "unilateral", "dumbbell", "intermediate", 9.0, 4, 5, true, "glutes_maximus", ["quadriceps"],
    "https://storage.googleapis.com/lbmethod-assets/exercises/bulgarian-split-squat.gif",
    "https://www.youtube.com/embed/2C-uNgKwPLE"),
  ex("walking-lunge", "Desplante Caminando", "glutes", "unilateral", "unilateral", "dumbbell", "intermediate", 8.4, 4, 4, true, "glutes_maximus", ["quadriceps", "hamstrings"],
    "https://storage.googleapis.com/lbmethod-assets/exercises/walking-lunge.gif"),
  ex("reverse-lunge", "Desplante Inverso", "glutes", "unilateral", "unilateral", "dumbbell", "beginner", 8.2, 3, 4, true, "glutes_maximus", ["quadriceps"],
    "https://storage.googleapis.com/lbmethod-assets/exercises/reverse-lunge.gif"),
  ex("step-up", "Escalón con Mancuernas", "glutes", "unilateral", "unilateral", "dumbbell", "beginner", 8.0, 3, 4, true, "glutes_maximus", ["quadriceps"],
    "https://storage.googleapis.com/lbmethod-assets/exercises/step-up.gif"),
  ex("curtsy-lunge", "Desplante Cruzado", "glutes", "unilateral", "unilateral", "dumbbell", "intermediate", 8.1, 3, 4, true, "glutes_maximus", ["quadriceps"],
    "https://storage.googleapis.com/lbmethod-assets/exercises/curtsy-lunge.gif"),
  ex("b-stance-rdl", "Peso Muerto Rumano Semiunilateral", "glutes", "unilateral", "unilateral", "dumbbell", "intermediate", 8.5, 3, 3, true, "glutes_maximus", ["hamstrings"],
    "https://storage.googleapis.com/lbmethod-assets/exercises/b-stance-rdl.gif"),

  // ---- Glutes: ABDUCTION / isolation pattern (Medius focus) ------------------
  ex("hip-abduction-machine", "Máquina de Abducción de Cadera", "glutes", "abduction", "isolation", "machine", "beginner", 8.0, 1, 1, false, "glutes_medius", [],
    "https://storage.googleapis.com/lbmethod-assets/exercises/hip-abduction-machine.gif"),
  ex("cable-glute-kickback", "Patada de Glúteo en Polea", "glutes", "abduction", "isolation", "cable", "beginner", 7.8, 1, 2, true, "glutes_medius", [],
    "https://storage.googleapis.com/lbmethod-assets/exercises/cable-glute-kickback.gif"),
  ex("banded-lateral-walk", "Caminata Lateral con Banda", "glutes", "abduction", "isolation", "band", "beginner", 7.0, 1, 2, false, "glutes_medius", [],
    "https://storage.googleapis.com/lbmethod-assets/exercises/banded-lateral-walk.gif"),
  ex("seated-band-abduction", "Abducción con Banda Sentada", "glutes", "abduction", "isolation", "band", "beginner", 6.8, 1, 1, false, "glutes_medius", []),
  ex("frog-pump", "Frog Pump (Puente de Rana)", "glutes", "abduction", "isolation", "bodyweight", "beginner", 7.2, 1, 1, false, "glutes_medius", [],
    "https://storage.googleapis.com/lbmethod-assets/exercises/frog-pump.gif"),
  ex("standing-cable-abduction", "Abducción de Pie en Polea", "glutes", "abduction", "isolation", "cable", "beginner", 7.6, 1, 2, true, "glutes_medius", [],
    "https://storage.googleapis.com/lbmethod-assets/exercises/standing-cable-abduction.gif"),
  ex("hyperextension-glute", "Hiperextensión con Enfoque en Glúteos", "glutes", "hip_hinge", "isolation", "bodyweight", "beginner", 8.0, 2, 2, false, "glutes_maximus", ["hamstrings"],
    "https://storage.googleapis.com/lbmethod-assets/exercises/hyperextension.gif"),

  // ---- Glutes: BANDA / peso corporal (home extras) -------------------------
  ex("band-hip-thrust", "Hip Thrust con Banda Elástica", "glutes", "hip_thrust", "compound", "band", "beginner", 8.0, 2, 2, false, "glutes_maximus", ["hamstrings"]),
  ex("kb-deadlift", "Peso Muerto con Pesa Rusa", "glutes", "hip_hinge", "compound", "kettlebell", "beginner", 8.2, 3, 3, false, "glutes_maximus", ["hamstrings", "back"]),
  ex("kb-rdl", "Peso Muerto Rumano con Pesa Rusa", "glutes", "hip_hinge", "compound", "kettlebell", "beginner", 8.0, 3, 3, false, "glutes_maximus", ["hamstrings"]),
  ex("db-sumo-squat", "Sentadilla Sumo con Mancuerna", "glutes", "knee_dominant", "compound", "dumbbell", "beginner", 7.8, 3, 3, false, "glutes_maximus", ["quadriceps"]),
  ex("db-hip-thrust", "Hip Thrust con Mancuerna", "glutes", "hip_thrust", "compound", "dumbbell", "beginner", 8.3, 3, 2, false, "glutes_maximus", ["hamstrings"]),
